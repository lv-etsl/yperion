...
class anchor_links_walker extends Walker_Nav_Menu{
 function start_el(&$output, $item, $depth, $args){
  ...
  $output .= $indent . '<li data-article-id="" class="nav-article-title">';
  ...
  $attributes .= ! empty( $item->url )        ? ' class="article-title" href="'   . $path .'"' : '';
